...
export const INITIAL_MARKERS: Marker[] = [
  ...
  { id: 'B040', name: 'Medium Blue', hex: '#4A90E2', setId: 'ohuhu-honolulu-b' },
  { id: 'G070', name: 'Forest Green', hex: '#2E8B57', setId: 'ohuhu-honolulu-b' },
  { id: 'E180', name: 'Dark Brown', hex: '#8B4513', setId: 'ohuhu-honolulu-b' },
  { id: 'CG05', name: 'Cool Grey 5', hex: '#A9A9A9', setId: 'ohuhu-honolulu-b' },
